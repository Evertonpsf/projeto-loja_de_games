...
export class ProdutoController {
    ...
    delete(@Param('id', ParseIntPipe) id: number) {  // Atravees do decorador Param deve ser convertido de string para numero  e reconhecer a variavel de caminho, para fazer este conhecimento da url que deve ser inserido na variavel.
        ...
        @Get('/maior/:maior')//colocamos assim('/nome/:nome') para nao confundir com o id na hora da busca.  Estamos definindo que o nome é uma variavel e ele que vamos buscar na linha 31
        @HttpCode(HttpStatus.OK) // Http status 200, ele retorna isso se estiver tudo certo.
        ...
        @Get('/menor/:menor')//colocamos assim('/nome/:nome') para nao confundir com o id na hora da busca.  Estamos definindo que o nome é uma variavel e ele que vamos buscar na linha 31
        @HttpCode(HttpStatus.OK) // Http status 200, ele retorna isso se estiver tudo certo.
